...
A Figuras \ref{fig:tela1} e \ref{fig:tela2} mostram um terreno gerado em um estágio inicial do arcabouço.
...
As Figuras \ref{fig:tela2}, \ref{fig:tela3} e \ref{fig:tela4} mostram terrenos gerados com uma \emph{interface} provisória, onde é possível escolher os parâmetros dos terrenos a serem gerados.
